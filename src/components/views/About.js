        ...
        <div class="container marketing ">
          ...
          <div class="row featurette pt-3 align-items-center">
            <div class="col-md-7">
              ...
              <p class="lead"> Somos una iglesia moldeada por las "Buenas noticias" de quién es
                Jesús y lo que ha hecho. ¡Y puede cambiar tu vida!</p>
            </div>
            <div class="col-md-5">
              <img src={iglesia} alt="Iglesia de Parque Casas" className="img-fluid rounded" />
          ...
          <div class="row featurette">
            <div class="col-md-7 order-md-2">
              <h2 class="featurette-heading fw-normal lh-1">Nuestra historia en <span class="text-body-secondary">Parque Casas.</span></h2>
              <p class="lead"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sit
                ...
                laoreet efficitur, neque mauris sagittis dui, in malesuada nisl</p>
            </div>
          ...
          <div class="row featurette">
            <div class="col-md-7">
              <h2 class="featurette-heading fw-normal lh-1">Otro panel informativo que quisieran agregar </h2>
              <p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sit amet volutpat eros. Donec efficitur semper semper. Vestibulum auctor rutrum ante ut pharetra. Phasellus luctus lacinia neque. Morbi porttitor mi ex, sit amet ornare nulla tempus nec. Sed id luctus neque. Morbi congue sagittis sagittis. Aenean sed condimentum mi, in porta erat. Aenean tempor facilisis risus id commodo...</p>
            </div>
            <div class="col-md-5">
              <img src={iglesia} alt="Iglesia de Parque Casas" className="img-fluid rounded" />
